...
% We give an example in education to illustrate the difference. In this phase, the active population rule can be explained by education: large cities (with large $N_i$) has more educational resources so that the people from these cities are more likely to be `active'.
